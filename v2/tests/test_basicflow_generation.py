...
class BasicFlowGenerationTests(unittest.TestCase):
    ...
    def test_generate_basicflow_assets_prefers_project_specific_path_when_detected(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            (project_root / "scenes" / "ui" / "game_pointer_hud.tscn").write_text("[gd_scene format=3]\n", encoding="utf-8")
        ...
        self.assertIn("Detected target mode: start_button_to_game_level.", result["meta"]["generation_summary"])
